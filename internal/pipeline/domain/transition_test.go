...
func TestTransitionMatrix(t *testing.T) {
	states := []domain.State{
		...
		domain.StateRejected, domain.StateSuperseded, domain.StateCancelled, domain.StateUnmanagedReview,
		domain.StateUnmanagedReady, domain.StateUnmanagedImporting, domain.StateUnmanagedImported,
	}
	legal := map[[2]domain.State]bool{
		...
		{domain.StateReleaseMatching, domain.StateUnmanagedReview}:      true,
		{domain.StateReleaseMatching, domain.StateUnmanagedReady}:       true,
		...
		{domain.StateUnmanagedReview, domain.StateUnmanagedReady}:       true,
		{domain.StateUnmanagedReview, domain.StateRejected}:             true,
		{domain.StateUnmanagedReview, domain.StateCancelled}:            true,
		{domain.StateUnmanagedReady, domain.StateUnmanagedImporting}:    true,
		{domain.StateUnmanagedImporting, domain.StateUnmanagedImported}: true,
		{domain.StateUnmanagedImporting, domain.StateUnmanagedReview}:   true,
	}
...
func TestTerminalStatesHaveNoOutgoingEdges(t *testing.T) {
	for _, terminal := range []domain.State{domain.StateImported, domain.StateUnmanagedImported, domain.StateRejected, domain.StateSuperseded, domain.StateCancelled} {
