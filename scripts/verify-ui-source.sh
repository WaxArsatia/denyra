...
! grep -q 'select_all' "$views/unmanaged.templ"
grep -q 'Starts with' "$views/unmanaged.templ"
grep -q 'state_revision_' "$views/unmanaged.templ"
grep -q 'Check now' "$views/unmanaged.templ"
grep -q 'confirm_migrations' "$views/migration_detail.templ"
grep -q 'state_revision_' "$views/migration_detail.templ"
